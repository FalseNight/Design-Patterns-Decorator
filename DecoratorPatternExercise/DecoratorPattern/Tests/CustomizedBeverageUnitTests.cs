...
namespace DecoratorPattern.Tests
{
    ...
    public class CustomizedBeverageUnitTests
    {
        ...
        [TestMethod]
        public void CustomizedBeverage_TallHazelnutFrappuccino()
        {
            // TASK: Replace this with your own drink creation/customization strategy.
            var drink = new TallHazelnutFrappuccino();
        ...
        public void CustomizedBeverage_TallSoyCaramelMacchiatoWithExtraWhip()
        {
            ...
            Assert.AreEqual(199, drink.Calories);
            Assert.AreEqual(4.25m, drink.Price);
        }
        ...
        private class TallHazelnutFrappuccino : Beverage
        {
            public string Description => "Tall Hazelnut Frappuccino";
        ...
        {
            public string Description => "Tall Raspberry Frappuccino";
        ...
        {
            public string Description => "Tall Frappuccino No Whip";
            public decimal Price => 3.25m;
        ...
        private class TallSoyCaramelMacchiatoWithExtraWhip : Beverage
        {
            ...
            public decimal Price => 4.25m;
            public int Calories => 199;
        }

        private class VentiLatte : Beverage
        {
            public string Description => "Venti Latte";
            public decimal Price => 4.15m;
            public int Calories => 240;
        }
        #endregion
    }
}
